...
DIST_DIR = Path(__file__).parent.parent.parent / "agent-builder" / "dist"
...
def generate_exe_agent(
    ...
    # Patch each placeholder (must match exactly what's in agent_python.py.template)
    SERVER_PLACEHOLDER  = "DRIFTLOCK_PLACEHOLDER_SERVER_URL_REPLACE_AT_RUNTIME_PADDING_TO_200_CHARS_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
    APIKEY_PLACEHOLDER  = "DRIFTLOCK_PLACEHOLDER_API_KEY_REPLACE_AT_RUNTIME_XXXXXXXXXXXXXXXXX"
    HOST_PLACEHOLDER    = "DRIFTLOCK_PLACEHOLDER_HOSTNAME_REPLACE_AT_RUNTIME_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
    SVCNAME_PLACEHOLDER = "DRIFTLOCK_PLACEHOLDER_SVCNAME_REPLACE_AT_RUNTIME_XXXXXXXXXXXXXXX"
